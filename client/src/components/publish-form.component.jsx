  ...
  const handleKeyDown = (e) => {
    if (e.keyCode === 188 || e.keyCode === 13) {
      ...
      if (tags.length < tagLimit) {
        ...
        toast.error(`Your can add max ${tagLimit} tags`);
      }
  ...
  return (
    <AnimationWrapper>
      <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4">
        ...
        <button
          className="w-12 h-12 justify-center items-center absolute right-[5vw] z-10 top-[5%] lg:top-[10%] hover:border rounded-full"
          onClick={handleCloseEvent}
        >
          <i className="mt-10 fi fi-br-cross-small"></i>
        </button>
